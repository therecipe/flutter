...
class QGraphicsSvgItem extends widgets.QGraphicsObject implements QGraphicsSvgItem_ITF {
  QGraphicsSvgItem QGraphicsSvgItem_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QGraphicsSvgItem_PTR"]);
  }

  void ConnectBoundingRect(core.QRectF Function() f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectBoundingRect", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectBoundingRect() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectBoundingRect"]);
  }
  ...
  String ElementId() {
    return callLocalFunction(["", this.Pointer(), this.className, "ElementId"]);
  }

  core.QSize MaximumCacheSize() {
    return callLocalFunction(["", this.Pointer(), this.className, "MaximumCacheSize"]);
  }

  void ConnectPaint(void Function(gui.QPainter painter, widgets.QStyleOptionGraphicsItem option, widgets.QWidget widget) f) {
  ...
  void Paint(gui.QPainter_ITF painter, widgets.QStyleOptionGraphicsItem_ITF option, widgets.QWidget_ITF widget) {
    callLocalFunction(["", this.Pointer(), this.className, "Paint", painter, option, widget]);
  }
  ...
  QSvgRenderer Renderer() {
    return callLocalFunction(["", this.Pointer(), this.className, "Renderer"]);
  }

  void SetElementId(String id) {
    callLocalFunction(["", this.Pointer(), this.className, "SetElementId", id]);
  }

  void SetMaximumCacheSize(core.QSize_ITF size) {
    callLocalFunction(["", this.Pointer(), this.className, "SetMaximumCacheSize", size]);
  }

  void SetSharedRenderer(QSvgRenderer_ITF renderer) {
    callLocalFunction(["", this.Pointer(), this.className, "SetSharedRenderer", renderer]);
  }
...
QGraphicsSvgItem NewQGraphicsSvgItemFromPointer(int ptr) {
  final r = new QGraphicsSvgItem();
  r.initFrom(ptr, "svg.QGraphicsSvgItem");
  return r;
}

QGraphicsSvgItem NewQGraphicsSvgItem(widgets.QGraphicsItem_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQGraphicsSvgItem", "", parent]);
}

QGraphicsSvgItem NewQGraphicsSvgItem2(String fileName, widgets.QGraphicsItem_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQGraphicsSvgItem2", "", fileName, parent]);
}
...
class QSvgGenerator extends gui.QPaintDevice implements QSvgGenerator_ITF {
  QSvgGenerator QSvgGenerator_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QSvgGenerator_PTR"]);
  }
  ...
  void SetOutputDevice(core.QIODevice_ITF outputDevice) {
    callLocalFunction(["", this.Pointer(), this.className, "SetOutputDevice", outputDevice]);
  }
  ...
  void SetViewBox(core.QRect_ITF viewBox) {
    callLocalFunction(["", this.Pointer(), this.className, "SetViewBox", viewBox]);
  }

  void SetViewBox2(core.QRectF_ITF viewBox) {
    callLocalFunction(["", this.Pointer(), this.className, "SetViewBox2", viewBox]);
  }
  ...
  core.QRect ViewBox() {
    return callLocalFunction(["", this.Pointer(), this.className, "ViewBox"]);
  }

  core.QRectF ViewBoxF() {
    return callLocalFunction(["", this.Pointer(), this.className, "ViewBoxF"]);
  }

  void ConnectDestroyQSvgGenerator(void Function() f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectDestroyQSvgGenerator", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectDestroyQSvgGenerator() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectDestroyQSvgGenerator"]);
  }

  void DestroyQSvgGenerator() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgGenerator"]);
  }

  void DestroyQSvgGeneratorDefault() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgGeneratorDefault"]);
  }
}

QSvgGenerator NewQSvgGeneratorFromPointer(int ptr) {
  final r = new QSvgGenerator();
  r.initFrom(ptr, "svg.QSvgGenerator");
  return r;
}

QSvgGenerator NewQSvgGenerator() {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgGenerator", ""]);
}
...
class QSvgIOHandler extends gui.QImageIOHandler implements QSvgIOHandler_ITF {
  QSvgIOHandler QSvgIOHandler_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QSvgIOHandler_PTR"]);
  }

  void DestroyQSvgIOHandler() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgIOHandler"]);
  }
}
...
class QSvgIconEngine extends gui.QIconEngine implements QSvgIconEngine_ITF {
  QSvgIconEngine QSvgIconEngine_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QSvgIconEngine_PTR"]);
  }

  void DestroyQSvgIconEngine() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgIconEngine"]);
  }
}
...
class QSvgRenderer extends core.QObject implements QSvgRenderer_ITF {
  QSvgRenderer QSvgRenderer_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QSvgRenderer_PTR"]);
  }

  bool Animated() {
    return callLocalFunction(["", this.Pointer(), this.className, "Animated"]);
  }

  core.QRectF BoundsOnElement(String id) {
    return callLocalFunction(["", this.Pointer(), this.className, "BoundsOnElement", id]);
  }

  core.QSize DefaultSize() {
    return callLocalFunction(["", this.Pointer(), this.className, "DefaultSize"]);
  }

  bool ElementExists(String id) {
    return callLocalFunction(["", this.Pointer(), this.className, "ElementExists", id]);
  }

  num FramesPerSecond() {
    return callLocalFunction(["", this.Pointer(), this.className, "FramesPerSecond"]);
  }
  ...
  void ConnectLoad(bool Function(String filename) f) {
  ...
  bool Load(String filename) {
    return callLocalFunction(["", this.Pointer(), this.className, "Load", filename]);
  }

  bool LoadDefault(String filename) {
    return callLocalFunction(["", this.Pointer(), this.className, "LoadDefault", filename]);
  }

  void ConnectLoad2(bool Function(core.QByteArray contents) f) {
  ...
  bool Load2(core.QByteArray_ITF contents) {
    return callLocalFunction(["", this.Pointer(), this.className, "Load2", contents]);
  }

  bool Load2Default(core.QByteArray_ITF contents) {
    return callLocalFunction(["", this.Pointer(), this.className, "Load2Default", contents]);
  }

  void ConnectLoad3(bool Function(core.QXmlStreamReader contents) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectLoad3", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectLoad3() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectLoad3"]);
  }

  bool Load3(core.QXmlStreamReader_ITF contents) {
    return callLocalFunction(["", this.Pointer(), this.className, "Load3", contents]);
  }

  bool Load3Default(core.QXmlStreamReader_ITF contents) {
    return callLocalFunction(["", this.Pointer(), this.className, "Load3Default", contents]);
  }

  gui.QMatrix MatrixForElement(String id) {
    return callLocalFunction(["", this.Pointer(), this.className, "MatrixForElement", id]);
  }

  void ConnectRender(void Function(gui.QPainter painter) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectRender", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectRender() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectRender"]);
  }

  void Render(gui.QPainter_ITF painter) {
    callLocalFunction(["", this.Pointer(), this.className, "Render", painter]);
  }

  void RenderDefault(gui.QPainter_ITF painter) {
    callLocalFunction(["", this.Pointer(), this.className, "RenderDefault", painter]);
  }

  void ConnectRender2(void Function(gui.QPainter painter, core.QRectF bounds) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectRender2", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectRender2() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectRender2"]);
  }

  void Render2(gui.QPainter_ITF painter, core.QRectF_ITF bounds) {
    callLocalFunction(["", this.Pointer(), this.className, "Render2", painter, bounds]);
  }

  void Render2Default(gui.QPainter_ITF painter, core.QRectF_ITF bounds) {
    callLocalFunction(["", this.Pointer(), this.className, "Render2Default", painter, bounds]);
  }

  void ConnectRender3(void Function(gui.QPainter painter, String elementId, core.QRectF bounds) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectRender3", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectRender3() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectRender3"]);
  }

  void Render3(gui.QPainter_ITF painter, String elementId, core.QRectF_ITF bounds) {
    callLocalFunction(["", this.Pointer(), this.className, "Render3", painter, elementId, bounds]);
  }

  void Render3Default(gui.QPainter_ITF painter, String elementId, core.QRectF_ITF bounds) {
    callLocalFunction(["", this.Pointer(), this.className, "Render3Default", painter, elementId, bounds]);
  }

  void ConnectRepaintNeeded(void Function() f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectRepaintNeeded", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectRepaintNeeded() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectRepaintNeeded"]);
  }

  void RepaintNeeded() {
    callLocalFunction(["", this.Pointer(), this.className, "RepaintNeeded"]);
  }

  void SetFramesPerSecond(num num) {
    callLocalFunction(["", this.Pointer(), this.className, "SetFramesPerSecond", num]);
  }
  ...
  void ConnectDestroyQSvgRenderer(void Function() f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectDestroyQSvgRenderer", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectDestroyQSvgRenderer() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectDestroyQSvgRenderer"]);
  }

  void DestroyQSvgRenderer() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgRenderer"]);
  }

  void DestroyQSvgRendererDefault() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgRendererDefault"]);
  }
...
QSvgRenderer NewQSvgRendererFromPointer(int ptr) {
  final r = new QSvgRenderer();
  r.initFrom(ptr, "svg.QSvgRenderer");
  return r;
}

QSvgRenderer NewQSvgRenderer(core.QObject_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgRenderer", "", parent]);
}

QSvgRenderer NewQSvgRenderer2(String filename, core.QObject_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgRenderer2", "", filename, parent]);
}

QSvgRenderer NewQSvgRenderer3(core.QByteArray_ITF contents, core.QObject_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgRenderer3", "", contents, parent]);
}

QSvgRenderer NewQSvgRenderer4(core.QXmlStreamReader_ITF contents, core.QObject_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgRenderer4", "", contents, parent]);
}
...
class QSvgWidget extends widgets.QWidget implements QSvgWidget_ITF {
  QSvgWidget QSvgWidget_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QSvgWidget_PTR"]);
  }

  void ConnectLoad(void Function(String file) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectLoad", "___REMOTE_CALLBACK___"], f);
  }
  ...
  void Load(String file) {
    callLocalFunction(["", this.Pointer(), this.className, "Load", file]);
  }

  void LoadDefault(String file) {
    callLocalFunction(["", this.Pointer(), this.className, "LoadDefault", file]);
  }

  void ConnectLoad2(void Function(core.QByteArray contents) f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectLoad2", "___REMOTE_CALLBACK___"], f);
  }
  ...
  void Load2(core.QByteArray_ITF contents) {
    callLocalFunction(["", this.Pointer(), this.className, "Load2", contents]);
  }

  void Load2Default(core.QByteArray_ITF contents) {
    callLocalFunction(["", this.Pointer(), this.className, "Load2Default", contents]);
  }
  ...
  void ConnectDestroyQSvgWidget(void Function() f) {
    callLocalAndRegisterRemoteFunction(["", this.Pointer(), this.className, "ConnectDestroyQSvgWidget", "___REMOTE_CALLBACK___"], f);
  }

  void DisconnectDestroyQSvgWidget() {
    callLocalAndDeregisterRemoteFunction(["", this.Pointer(), this.className, "DisconnectDestroyQSvgWidget"]);
  }

  void DestroyQSvgWidget() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgWidget"]);
  }

  void DestroyQSvgWidgetDefault() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQSvgWidgetDefault"]);
  }
...
QSvgWidget NewQSvgWidgetFromPointer(int ptr) {
  final r = new QSvgWidget();
  r.initFrom(ptr, "svg.QSvgWidget");
  return r;
}

QSvgWidget NewQSvgWidget(widgets.QWidget_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgWidget", "", parent]);
}

QSvgWidget NewQSvgWidget2(String file, widgets.QWidget_ITF parent) {
  initModule();
  return callLocalFunction(["", "", "svg.NewQSvgWidget2", "", file, parent]);
}
