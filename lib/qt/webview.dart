...
class QtWebView extends Internal implements QtWebView_ITF {
  QtWebView QtWebView_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "QtWebView_PTR"]);
  }

  void DestroyQtWebView() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyQtWebView"]);
  }
...
QtWebView NewQtWebViewFromPointer(int ptr) {
  final r = new QtWebView();
  r.initFrom(ptr, "webview.QtWebView");
  return r;
}

void QtWebView_Initialize() {
  initModule();
  callLocalFunction(["", "", "webview.QtWebView_Initialize", ""]);
}
