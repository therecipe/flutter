...
class PseudoQJSEngine extends Internal implements PseudoQJSEngine_ITF {
  ...
  PseudoQJSValue GlobalObject() {
    return callLocalFunction(["", this.Pointer(), this.className, "GlobalObject"]);
  }

  PseudoQJSValue NewArray(int length) {
    return callLocalFunction(["", this.Pointer(), this.className, "NewArray", length]);
  }

  PseudoQJSValue NewObject() {
    return callLocalFunction(["", this.Pointer(), this.className, "NewObject"]);
  }

  PseudoQJSEngine PseudoQJSEngine_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "PseudoQJSEngine_PTR"]);
  }
}

PseudoQJSEngine NewPseudoQJSEngineFromPointer(int ptr) {
  final r = new PseudoQJSEngine();
  r.initFrom(ptr, "interop.PseudoQJSEngine");
  return r;
}

PseudoQJSEngine PseudoQJSEngine_qjsEngine(core.QObject_ITF object) {
  initModule();
  return callLocalFunction(["", "", "interop.PseudoQJSEngine_qjsEngine", "", object]);
}
...
class PseudoQJSValue extends Internal implements PseudoQJSValue_ITF {
  PseudoQJSValue Call(List<PseudoQJSValue> args) {
    return callLocalFunction(["", this.Pointer(), this.className, "Call", args]);
  }

  PseudoQJSValue CallMethod(String name, List<PseudoQJSValue> args) {
    return callLocalFunction(["", this.Pointer(), this.className, "CallMethod", name, args]);
  }
  ...
  void DestroyPseudoQJSValue() {
    callLocalFunction(["", this.Pointer(), this.className, "DestroyPseudoQJSValue"]);
  }

  PseudoQJSValue PseudoQJSValue_PTR() {
    return callLocalFunction(["", this.Pointer(), this.className, "PseudoQJSValue_PTR"]);
  }
}

PseudoQJSValue NewPseudoQJSValueFromPointer(int ptr) {
  final r = new PseudoQJSValue();
  r.initFrom(ptr, "interop.PseudoQJSValue");
  return r;
}

PseudoQJSValue NewPseudoQJSValue2(core.QVariant_ITF other) {
  initModule();
  return callLocalFunction(["", "", "interop.NewPseudoQJSValue2", "", other]);
}
